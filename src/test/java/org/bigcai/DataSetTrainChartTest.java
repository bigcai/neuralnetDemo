...
import org.bigcai.vo.ChartRender;
...
/**
 * 使用 List<DataForTrainVo> dataForTrainVoList 中的记录对 w 调参，（每条记录调参一次）
 *
 * 执行 1 万次调参
 *
 *
 *
 */
public class DataSetTrainChartTest {

    public static void main(String[] args) throws Exception {
        HistoryRecorder.weightVectorHistory.clear();
        ...
        System.out.println("参数变化：" + JSONUtil.toJsonPrettyStr(HistoryRecorder.weightVectorHistory));
        ChartRender.beetlString();
    ...
    private static MultiLayerNeuralNetwork buildMultiLayerNeuralNetwork() {
        ...
        NeuralUnit fooNeural1 = new NeuralUnit("输入层1号", weights1, new BigDecimal(0.1));

        List<BigDecimal> weights2 = new ArrayList<>();
        weights2.add(new BigDecimal(0.3));
        weights2.add(new BigDecimal(0.4));
        NeuralUnit fooNeural2 = new NeuralUnit("输入层2号", weights2, new BigDecimal(0.2));
        ...
        NeuralUnit fooNeural3 = new NeuralUnit("输出层0号", weights3, new BigDecimal(0.3));
